...
namespace DonaLaura.Infra.Base
{
    ...
    {
        private static readonly string _connectionString = ConfigurationManager.ConnectionStrings["DBDonaLaura"].ConnectionString;
        private static readonly string _providerName = ConfigurationManager.ConnectionStrings["DBDonaLaura"].ProviderName;
